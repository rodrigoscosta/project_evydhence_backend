...
class Person(models.Model):
    ...
    sexo = models.CharField(max_length=1, null=False, default='M')
    ...
    numeroResidencia = models.CharField(max_length=10, null=False)
    complemento = models.CharField(max_length=100, null=True, default='', blank=True)
